...
int main( int argc, char **argv ) {
  ...
  gtk_window_set_title( GTK_WINDOW( window ), "Horizontal pane" );
  ...
  gtk_paned_pack1( GTK_PANED( hpane ), button1, FALSE, FALSE );
  gtk_paned_pack2( GTK_PANED( hpane ), button2, FALSE, FALSE );
