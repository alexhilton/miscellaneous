...
int main( int argc, char **argv ) {
  ...
  /* create adjustment widget for both spin and scale button */
  GtkObject *spinadjust = gtk_adjustment_new( 5.f, 0.f, 10.f, 1.f, 5.f, 0.f );
  GtkObject *scaleadjust = gtk_adjustment_new( 5.f, 0.f, 10.f, 1.f, 5.f, 0.f );
  /* create spin button and scale button based on adjustment */
  GtkWidget *spin = gtk_spin_button_new( GTK_ADJUSTMENT( spinadjust ), 1.0, 0 );
  GtkWidget *scale = gtk_hscale_new( GTK_ADJUSTMENT( scaleadjust ) );
