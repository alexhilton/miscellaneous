/**
 * $Header: /home/alex/work/gtk-work/gtk-examples/widget/setup.c,v 1.2 2009/10/06 18:41:11 alex Exp alex $
 * $Author: alex $
 * $Date: 2009/10/06 18:41:11 $
 *
 * setup.c
 ...
 * $Revision: 1.2 $
 * $Log: setup.c,v $
 * Revision 1.2  2009/10/06 18:41:11  alex
 * Deactive the button_progress prevent from install twice.
 * Delete some debuggin message.
 *
 * Revision 1.1  2009/10/06 18:20:21  alex
 * Initial revision
 *
 */
#include <gtk/gtk.h>
...
static const char rcs_id[] = "$Id: setup.c,v 1.2 2009/10/06 18:41:11 alex Exp alex $";
...
static void button_progress_clicked( GtkWidget *button, Data *data ) {
  /* first deactive the button, prevent from being clicked twice */
...
/* End of $Source: /home/alex/work/gtk-work/gtk-examples/widget/setup.c,v $ */
