 ...
 * Change lstat into stat
 * The only difference of lstat and stat is that when file is symbolic link,
 * lstat retrieve infomation about symbolic link, while stat retrieve infomation
 * about the file to which symbolic points.
 */
#include <stdio.h>
#include <unistd.h>
#include <sys/stat.h>
